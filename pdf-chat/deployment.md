...
3. Configure the following settings:
 ...
 4. Add the following environment variables under **Environment**:
    ...
    - *Note: Render blocks outgoing SMTP ports (25, 465, 587) on its Free Tier. Standard SMTP email delivery will fail on Render. We recommend Option 1 (Netlify) instead for free Gmail SMTP support.*
