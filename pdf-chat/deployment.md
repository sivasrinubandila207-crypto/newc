...
3. Configure the following settings:
 ...
 4. Add the following environment variables under **Environment**:
    ...
    - `BREVO_SMTP_PORT`: `587`
    - `BREVO_USER`: Your Brevo account email or SMTP login username.
    - `BREVO_PASS`: Your Brevo SMTP API Key.
    - `EMAIL_FROM`: Your authorized sender email in Brevo.
    - *Note: Render blocks outgoing SMTP ports (25, 465, 587) by default on some free instance profiles to prevent spam. If you experience timeout issues, contact Render support to unblock SMTP ports for your service, or verify your Brevo credentials are correct.*
