...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (errorMessage.includes('ENOTFOUND') || errorMessage.includes('getaddrinfo') || errorMessage.includes('network')) {
      ...
      friendlyMessage = `🔑 Invalid API key. Please check your ${keyName} in the .env file.`;
      statusCode = 401;
      ...
      friendlyMessage = `🛠 ${providerName} server error. This is temporary — please try again in a few seconds.`;
      statusCode = 502;
    }
